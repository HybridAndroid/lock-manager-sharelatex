module.exports = (grunt) ->
	...
	grunt.registerTask 'compile:server', 'Compile the server side coffee script', ['coffee:app', 'coffee:app_dir']
	grunt.registerTask 'compile:unit_tests', 'Compile the unit tests', ['coffee:unit_tests']
	grunt.registerTask 'compile', 'Compiles everything need to run lock-manager-sharelatex', ['compile:server', 'compile:unit_tests']
